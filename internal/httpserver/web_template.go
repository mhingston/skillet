...
{{if .Detail.Metadata}}<section class="detail-section"><h2>Metadata</h2><dl class="detail-list">{{range metadata .Detail.Metadata}}<div><dt>{{index . 0}}</dt><dd>{{index . 1}}</dd></div>{{end}}</dl></section>{{end}}
